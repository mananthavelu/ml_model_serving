...
from src.data import (
    load_housing_data, save_processed_data, check_data_quality,
    HousingDataValidator, HousingPreprocessor
)
...
def process_housing_data(
    ...
    save_processed_data(pd.concat([X_train, y_train], axis=1), f"{output_dir}/train.csv")
